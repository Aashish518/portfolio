            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {projects.map((project, index) => (
                    ...
                    >
                        ...
                        <div className="h-48 bg-slate-100 border-b border-slate-100 flex items-center justify-center mb-6 overflow-hidden">
                            <Code
                        ...
                        <div className="flex-1 flex flex-col px-2">
                            ...
                            <h3
                                className="font-bold text-slate-900 mb-3 group-hover:underline
                                           decoration-slate-400 underline-offset-4 transition-all
                            ...
                            <div className="flex flex-wrap gap-2 mb-6">
                                {project.technologies.map((tech, idx) => (
                                    <span
                                        key={idx}
                                        className="px-2.5 py-1 bg-slate-100 text-slate-700
                                                   border border-slate-200 font-medium rounded-md
                                                   text-xs sm:text-sm"
                                    >
                                        {tech}
                                    </span>
